const en: Record<string, any> = {
  ...
  hero: {
    ...
    title2: "Scalable",
    title3: "Ecosystems",
    description: "Software Engineer and FullStack Developer specializing in modular System Architecture and high-performance backends. Building robust digital infrastructure and immersive interfaces since init().",
  ...
  logs: {
    ...
    work: {
      ...
      desc1: "Led the design and development of an ERP system from scratch for logistics and sales management. Implemented Hexagonal Architecture and Microservices to isolate core business logic. Optimized databases, reducing query times by 40%, and elevated user experience with real-time data synchronization utilizing WebSockets.",
